...
class FileInboxAdmin(ModelAdmin):
    ...
    def get_queryset(self, request):
        ...
        # If no assignment filter is set, default to unassigned only
...
class FileInboxAdmin(ModelAdmin):
    ...
    def get_queryset(self, request):
        # Only show unassigned items — assigned items are hidden since
        # their file has been moved to the Resource and inbox copy deleted
